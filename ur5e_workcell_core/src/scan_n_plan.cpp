...
public:
  ScanNPlan() : Node("scan_n_plan", rclcpp::NodeOptions().automatically_declare_parameters_from_overrides(true))
  {
    ...
    vision_client_ = this->create_client<ur5e_workcell_core::srv::LocalizePart>("localize_part");
  }
  ...
  void start(const std::string &base_frame)
  {
    ...
    auto request = std::make_shared<ur5e_workcell_core::srv::LocalizePart::Request>();
...
private:
  ...
  rclcpp::Client<ur5e_workcell_core::srv::LocalizePart>::SharedPtr vision_client_;
};
